...
gj.widget = function() {
    ...
    function(a) {
        ...
        base: {
            ...
            style: {
                wrapper: "gj-grid_remove-wrapper",
                table: "gj-grid_remove gj-grid_remove-md",
                loadingCover: "gj-grid_remove-loading-cover",
                loadingText: "gj-grid_remove-loading-text",
                header: {
                    cell: void 0,
                    sortable: "gj-cursor-pointer gj-unselectable"
                },
                content: {
                    rowSelected: "gj-grid_remove-md-select"
                }
            },
            icons: {
                asc: "▲",
        ...
        bootstrap: {
            style: {
                wrapper: "gj-grid_remove-wrapper",
                table: "gj-grid_remove gj-grid_remove-bootstrap gj-grid_remove-bootstrap-3 table table-bordered table-hover",
                content: {
                    rowSelected: "active"
                }
            },
        ...
        bootstrap4: {
            style: {
                wrapper: "gj-grid_remove-wrapper",
                table: "gj-grid_remove gj-grid_remove-bootstrap gj-grid_remove-bootstrap-4 table table-bordered table-hover",
                content: {
                    rowSelected: "active"
                }
            },
        ...
        initialize: function(a) {
            ...
            gj.grid.methods.localization(b), 0 === c.length ? (c = $('<div data-role="wrapper" />').addClass(b.style.wrapper), a.wrap(c)) : c.addClass(b.style.wrapper), b.width && a.parent().css("width", b.width), b.minWidth && a.css("min-width", b.minWidth), b.fontSize && a.css("font-size", b.fontSize), "autogrow" === b.headerRowHeight && a.addClass("autogrow-header-row"), "fixed" === b.bodyRowHeight && a.addClass("fixed-body-rows"), a.addClass(b.style.table), "checkbox" === b.selectionMethod && b.columns.splice(gj.grid.methods.getColumnPositionNotInRole(a), 0, {
                ...
                headerCssClass: "gj-grid_remove-select-all",
                stopPropagation: !0
    ...
    function(a) {
        ...
        private: {
            init: function(a) {
                ...
                a.addClass("gj-grid_remove-scrollable"), c.css("width", d.outerWidth()), c.height(e)
            },
            refresh: function(a) {
        ...
        base: {
            ...
            inlineEditing: {
                ...
                managementColumnConfig: {
                    ...
                    cssClass: "gj-grid_remove-management-column"
                }
            }
        },
        bootstrap: {
        ...
        config: {
            base: {
                ...
                title: void 0,
                style: {
                    toolbar: "gj-grid_remove-md-toolbar"
                }
            },
            bootstrap: {
                style: {
                    toolbar: "gj-grid_remove-bootstrap-toolbar"
                }
            },
            bootstrap4: {
                style: {
                    toolbar: "gj-grid_remove-bootstrap-4-toolbar"
                }
            }
        },
        private: {
        ...
        private: {
            init: function(a, b) {
                ...
                if (c = a.find('thead tr[data-role="caption"] th'), c.length) {
                    for (e = 0; e < c.length - 1; e++) d = $(c[e]), f = $('<div class="gj-grid_remove-column-resizer-wrapper" />'), h = parseInt(d.css("padding-right"), 10) + 3, g = $('<span class="gj-grid_remove-column-resizer" />').css("margin-right", "-" + h + "px"), g.draggable({
                        start: function() {
                            a.addClass("gj-unselectable"), a.addClass("gj-grid_remove-resize-cursor")
                        },
                        stop: function() {
                            a.removeClass("gj-unselectable"), a.removeClass("gj-grid_remove-resize-cursor"), this.style.removeProperty("top"), this.style.removeProperty("left"), this.style.removeProperty("position")
                        },
        ...
        config: {
            base: {
                ...
                style: {
                    targetRowIndicatorTop: "gj-grid_remove-row-reorder-indicator-top",
                    targetRowIndicatorBottom: "gj-grid_remove-row-reorder-indicator-bottom"
                }
            }
        },
        private: {
            ...
            createDragStopHandler: function(a, b) {
                return function(c, d) {
                    $('table[data-role="draggable-clone"]').draggable("destroy").remove(), a.removeClass("gj-unselectable"), b.siblings('tr[data-role="row"]').each(function() {
                        ...
                        i.removeClass("gj-grid_remove-top-border"), i.removeClass("gj-grid_remove-bottom-border"), i.droppable("destroy")
                    })
                }
            },
            createDroppableOverHandler: function(a) {
                return function(b) {
                    var c = $(this);
                    c.data("position") < a.data("position") ? c.addClass("gj-grid_remove-top-border") : c.addClass("gj-grid_remove-bottom-border")
                }
            },
        ...
        private: {
            ...
            createDragStopHandler: function(a, b) {
                return function(c, d) {
                    $('table[data-role="draggable-clone"]').draggable("destroy").remove(), a.removeClass("gj-unselectable"), b.siblings("th").each(function() {
                        ...
                        c.removeClass("gj-grid_remove-left-border").removeClass("gj-grid_remove-right-border"), c.closest("table").find('tbody tr[data-role="row"] td:nth-child(' + (c.index() + 1) + ")").removeClass("gj-grid_remove-left-border").removeClass("gj-grid_remove-right-border"), c.droppable("isOver", d) && (f < g ? c.before(b) : c.after(b), gj.grid.plugins.columnReorder.private.moveRowCells(a, g, f), e.columns.splice(f, 0, e.columns.splice(g, 1)[0])), c.droppable("destroy")
                    })
                }
            },
            ...
            createDroppableOverHandler: function(a, b) {
                return function(c) {
                    var d = $(this),
                        e = a.data();
                    gj.grid.methods.getColumnPosition(e.columns, d.data("field")) < gj.grid.methods.getColumnPosition(e.columns, b.data("field")) ? (d.addClass("gj-grid_remove-left-border"), a.find('tbody tr[data-role="row"] td:nth-child(' + (d.index() + 1) + ")").addClass("gj-grid_remove-left-border")) : (d.addClass("gj-grid_remove-right-border"), a.find('tbody tr[data-role="row"] td:nth-child(' + (d.index() + 1) + ")").addClass("gj-grid_remove-right-border"))
                }
            },
            droppableOut: function() {
                var a = $(this);
                a.removeClass("gj-grid_remove-left-border").removeClass("gj-grid_remove-right-border"), a.closest("table").find('tbody tr[data-role="row"] td:nth-child(' + (a.index() + 1) + ")").removeClass("gj-grid_remove-left-border").removeClass("gj-grid_remove-right-border")
            }
        },
        public: {},
        configure: function(a, b, c) {
