...
WebPortal.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = WebPortal;

    // excluding the parent
    if (namespaceArr[0] === 'WebPortal') {
...
WebPortal.createNameSpace("WebPortal.Cookies");

WebPortal.Cookies.getCookie = function (ck_name) {
...
WebPortal.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
